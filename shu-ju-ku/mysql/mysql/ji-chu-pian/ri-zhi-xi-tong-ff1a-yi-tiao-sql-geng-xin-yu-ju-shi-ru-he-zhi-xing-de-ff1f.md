...
![](/static/image/16a7950217b3f0f4ed02db5db59562a7.png)
...
今天，我介绍了 MySQL 里面最重要的两个日志，即**物理日志 redo log 和逻辑日志 binlog**。
...
比如，你每天 0 点做一次全量备份，而要恢复出一个到昨天晚上 23 点的备份。一周一备最坏情况就要应用一周的 binlog 了。
